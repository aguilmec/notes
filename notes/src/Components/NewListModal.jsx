...
export default function NewListModal({ handleClose, handleNewList }){
    ...
    return(
        <div className="fixed inset-0 flex items-center justify-center z-50">
            ...
            <div className="flex flex-col bg-white px-2 py-8 shadow z-10 w-4/6">
                <p className="cursor-default text-[18px] font-semibold mb-[35px]">New List</p>
                <div className="flex gap-[20px] justify-center">
                    <p className="text-md cursor-default">List:</p>
                    <input onChange={(e)=>{setValue(e.target.value)}} type="text" placeholder="List name..." className="w-4/6 pl-[15px] border-solid border-slate-300 border-[1px]"></input>
                </div>
